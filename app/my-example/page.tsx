...
export const metadata: Metadata = {
  title: "My ejemplo de shadcn/ui",
  description: "Mi ejemplo sencillo de composición de primitives de shadcn/ui.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-5 py-8 sm:px-8 sm:py-12">
      <div className="mb-10 flex items-center justify-between gap-4">
        ...
        <p className="font-mono text-xs text-muted-foreground">/my-example</p>
      </div>
